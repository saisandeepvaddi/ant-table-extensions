...
import {ExportTableButton, ITableExportFields, ITableProps, SearchTableInput, Table,} from "../src";
...
export const CustomCsvConfig = () => {
    return (
        <React.Fragment>
            <p>
                Customize CSV format (delimiter, new line, ...)<br />
                <b>NOTE:</b> Use PapaParse config format. cf.
                <a href="https://www.papaparse.com/docs#json-to-csv" target="_blank">
            ...
            <Table
                ...
                columns={columns}
                exportable
                exportableProps={{showColumnPicker: true, csvConfig: {delimiter: ";"}}}
            />
        </React.Fragment>
    );
};
