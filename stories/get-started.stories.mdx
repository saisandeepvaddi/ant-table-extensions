...
> **NOTE:** This library works in a project already using React Ant Design. So you should have `antd` library and it's styles already. Visit [ant official docs page](https://ant.design) for installation.
...
function App() {
  return <Table dataSource={dataSource} columns={columns} {..any other ant props} />
}
